    ...
    route("/partners") {
        authenticate("auth-jwt") {
            ...
            get("/points/{pointId}") {
                ...
                val point = tradingPointRepository.getPointById(pointId)
                val settings = tradingPointRepository.getSettingsByPointId(pointId)
                ...
                call.respond(TradingPointDetailsDto(point, settings, partner.baseCurrency))
            }
