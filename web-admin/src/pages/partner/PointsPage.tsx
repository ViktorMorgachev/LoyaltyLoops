  ...
  const handleCreatePoint = async () => {
    try {
      const payload = {
        ...
        visitsTarget: (strategy === 'VISIT_COUNTER' || strategy === 'HYBRID') ? parseInt(visitsTarget) : null,
        baseCashback: (strategy === 'TIERED_LTV' || strategy === 'HYBRID') ? parseInt(cashback) / 100.0 : null
      };
