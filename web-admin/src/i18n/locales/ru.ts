  ...
  translation: {
    ...
    about: {
      ...
      loyalty_types: {
        ...
        tiered_desc: "Клиент накапливает баллы, повышает свой уровень и получает больший кэшбэк. Проценты кэшбэка задаются партнером по уровням: Start, Silver, Gold",
    ...
    point_details: {
      ...
      additional_info_hint: "До 30 символов — увидят клиенты в карточке",
    ...
    landing: {
      ...
      mechanics: {
        accumulative: {
          ...
          desc: "Клиент накапливает баллы, повышает свой уровень и получает больший кэшбэк. Проценты кэшбэка задаются партнером по уровням: Start, Silver, Gold."
        },
        visits: {
      ...
      result: {
        ...
        stat_1: "Увеличение повторных покупок",
        stat_2: "Рост среднего чека",
        stat_3: "Полная аналитика клиентского поведения"
      },

      roadmap: {
        title: "Roadmap проекта 🚀",
        subtitle: "Мы не стоим на месте. Вот что ждет LoyaltyLoops в ближайшем будущем.",
      ...
      features: {
        ...
        security_desc: "Централизованная работа с токенами, контроль прав доступа и журналирование всех действий.",
      ...
      cta: {
        ...
        subtitle: "Присоединяйтесь к экосистеме LoyaltyLoops уже сегодня.",
        contact_line: "Присоединяйтесь к экосистеме уже сегодня — напишите нам на",
        quick_start: "Быстрый старт за 15 минут",
        no_hardware: "Никакого сложного оборудования",
        trial: "14 дней пробный период",
        copy_hint: "или скопируйте адрес",
